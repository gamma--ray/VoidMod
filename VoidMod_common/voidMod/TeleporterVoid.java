...
public class TeleporterVoid extends Teleporter {
                ...
                for (int i1 = -2; i1 <= 2; ++i1) {
                    for (int j1 = -1; j1 < 3; ++j1) {
                        ...
                        this.worldServerInstance.setBlock(k1, l1, i2,
                                flag ? Block.sandStone.blockID : 0);
                    }
                }
            }
    ...
    public boolean placeInExistingPortal(Entity par1Entity, double par2,
            ...
            for (k1 = l - short1; k1 <= l + short1; ++k1) {
                ...
                for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1) {
                    ...
                    for (int i2 = this.worldServerInstance.getActualHeight() - 1; i2 >= 0; --i2) {
                        if (this.worldServerInstance.getBlockId(k1, i2, l1) == VoidMod.portalTutorialBlock.blockID) {
                            while (this.worldServerInstance.getBlockId(k1,
                                    i2 - 1, l1) == VoidMod.portalTutorialBlock.blockID) {
                                --i2;
                            }
        ...
        if (d3 >= 0.0D) {
            ...
            if (this.worldServerInstance.getBlockId(i - 1, j, k) == VoidMod.portalTutorialBlock.blockID) {
                j2 = 2;
            }
            ...
            if (this.worldServerInstance.getBlockId(i, j, k - 1) == VoidMod.portalTutorialBlock.blockID) {
                j2 = 3;
            }
                ...
                for (l2 = -1; l2 < 4; ++l2) {
                    ...
                    this.worldServerInstance
                            .setBlock(
                                    ...
                                    j3,
                                    i4,
                                    flag ? Block.sandStone.blockID
                                            : VoidMod.portalTutorialBlock.blockID,
                                    0, 2);
                }
            }
